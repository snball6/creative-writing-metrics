...
##1) No Skip Days What if I had maintained my writing streak and written my minimum of 0.25 everyday. In 2025, I skipped writing 57 days - the bulk of them during the pause periods noted previously.
...
##2) Raised Minimum What if I had maintained my daily writing streak and also raised my minimum to at least 0.5 hours every day?
...
My past experience with goals and resolutions has been to start small and obtainable and increase from there. Instead of a yearly total goal, I am going to be focused on the weekly total. This way if life events disrupt my writing or an experiment fails to work out, I need only start anew the next week, and not be bogged down with the feeling that I need to "catch up" and work even harder to make up the difference.

I decided to round down my weekly model year goal to 7.5 hours and set this not as my currently weekly goal at the start of 2026, but as weekly total I want to reach by the end of the year. Given my 2025 mean was only 5.5, I will start my year aiming for 6 hours and hope to increase that gradually over the year by the remaining 1.5.

## Tracking Dashboard:

I created a Tableau Dashboard to give me a clear set of visuals to benchmark my progress on my goals.
...
TODO: Finish filling out Python section
...
Returning to my visualization I decided to spot check a few other oddities, such as:

-   4.5 hours on a Sunday \_\_\_\_ - this was correct. I was even able to find the text message chain with my project PM as she was coordinating scheduling team members to work on that project over the weekend ahead of an important client demo.

-   Shifts in my usual Mon-Thu schedule on \_\_ and \_\_ - was to accommodate holidays

-   Extra long work days \_\_ and \_\_  - was due to evening company events like an extreme interviews or quarterly all hand's meetings

I also wanted to double check all holidays were parsed correctly. For 2023 and 2024 there should have been 10. I found 9 and 11. 

After matching up the dates flagged for 2023 against my holidays list and accounting for effective dates (new years fell on a weekend), I found that my missing holiday was my float holiday. Presumably it had been applied to one of my PTO days that year.

For 2024, I remembered the issue--I had mistakenly believed I still had a float holiday left to use up end of year, but I did not. I corrected the timesheet to use PTO instead. 

### Manual-Categorizing:

For my use case, it was likely to be useful to break down PTO and Partial PTO days with more granularity to know if these were days I was more or less likely to have extra writing time--for example home sick with a migraine or intentionally out for the day as a mini vacation.

These were not going to be retrievable from the timesheet data, but were possible to reverse engineer when working with the smaller data set of of specific \_\_\_\_ PTO and Partial PTO dates, rather than trying to come up with all my sick days for the last 3 years.

--PTO was tracked and used down to a quarter of an hour, and as an hourly employee, I was required to use PTO to bridge the gap if my schedule hours were short at the end of the week. For example, since I had a 4 day 32 hours per week schedule, if at the end of the week, I had logged only 31.5 hours, I would need to use up .5 hours of PTO. For the context of this creative writing metric analysis, that .5 hours of PTO is unlikely to have any significant impact on my writing output. 

These answers or assumptions were all included in the python code, again, so that I could easily adjust and recreate the dataset and have a tracked place to know what categorizations high confidence vs guesses--and why I made that guess.

This data then was joined into the script  so that I only needed to run the script once to get back the full dataset, rather than running multiple scripts against the data.
