...
#     geom_point(alpha = .25)
```
I do not plan to work on a 3rd or later draft in 2026. To approximate this difference, I took my 2024 starting data set and replace my 3rd+ draft writing sessions with my median 2nd draft writing sessions from that year (____). This created the following reduction:
...
<look at the resulting stats I could target>
<what those numbers might look like>

## What ifs

<toggle on/off adjustments>
-I had written the minimum .25 all days
-Or if I raised that minimum to .5
-I had extra dedicated writing day a week (moderate 1-2 hr)
-I had an extra highly dedicated writing day a month (4 hrs) 
