...
timeline <- read.csv("timeline_annotated.csv")
...
2025 was spent almost exclusively on the harder stages of the Raven 2nd draft with intermittent breaks when I chose to pause in the first half of the year to accommodate life events. I saw a spike in my hours when I began work on the Katarin 2nd draft.
